...
using namespace GView::Type::ASM;
using namespace AppCUI::Controls;

Panels::Information::Information(Reference<GView::Type::ASM::ASMFile> _asmf) : TabPage("&Information")
{
    asmf      = _asmf;
...
void Panels::Information::UpdateGeneralInformation()
{
    ...
    general->AddItem(
          { "Size",
            tempStr.Format("%s bytes", n.ToString(asmf->obj->GetData().GetSize(), { NumericFormatFlags::None, 10, 3, ',' }).data()) });
}
