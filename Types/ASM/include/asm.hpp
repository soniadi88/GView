...
namespace Type
{
    namespace ASM
    {
        ...
        namespace TokenType
        {
            ...
            constexpr uint32 Keyword_Ret = 1024;
            constexpr uint32 Keyword_Moveby = 1025;
            constexpr uint32 Keyword_If = 1026;
            constexpr uint32 Keyword_Resizeto = 1027;
            constexpr uint32 Keyword_In = 1028;
            constexpr uint32 Keyword_Scrollto = 1029;
            constexpr uint32 Keyword_Catch = 1030;
            constexpr uint32 Keyword_Infinity = 1031;
            constexpr uint32 Keyword_Resizeby = 1032;
            constexpr uint32 Keyword_History = 1033;
            constexpr uint32 Keyword_Scrollby = 1034;
            constexpr uint32 Keyword_Pop = 1035;
            constexpr uint32 Keyword_Callee = 1036;
            constexpr uint32 Keyword_Transient = 1037;
            constexpr uint32 Keyword_Debugger = 1038;
            constexpr uint32 Keyword_Do = 1039;
            constexpr uint32 Keyword_Private = 1040;
            constexpr uint32 Keyword_Self = 1041;
            constexpr uint32 Keyword_Const = 1042;
            constexpr uint32 Keyword_Delete = 1043;
            constexpr uint32 Keyword_Caller = 1044;
            constexpr uint32 Keyword_Blur = 1045;
            constexpr uint32 Keyword_Defaultstatus = 1046;
            constexpr uint32 Keyword_Confirm = 1047;
            constexpr uint32 Keyword_Innerheight = 1048;
            constexpr uint32 Keyword_Scrollbars = 1049;
            constexpr uint32 Keyword_Throw = 1050;
            constexpr uint32 Keyword_Frames = 1051;
            constexpr uint32 Keyword_Enum = 1052;
            constexpr uint32 Keyword_Length = 1053;
            constexpr uint32 Keyword_Interface = 1054;
            constexpr uint32 Keyword_Return = 1055;
            constexpr uint32 Keyword_Captureevents = 1056;
            constexpr uint32 Keyword_Push = 1057;
            constexpr uint32 Keyword_Tostring = 1058;
            constexpr uint32 Keyword_Array = 1059;
            constexpr uint32 Keyword_Abstract = 1060;
            constexpr uint32 Keyword_Name = 1061;
            constexpr uint32 Keyword_Package = 1062;
            constexpr uint32 Keyword_Default = 1063;
            constexpr uint32 Keyword_Switch = 1064;
            constexpr uint32 Keyword_Document = 1065;
            constexpr uint32 Keyword_Watc = 1066;
            constexpr uint32 Keyword_Typeof = 1067;
            constexpr uint32 Keyword_Case = 1068;
            constexpr uint32 Keyword_Finally = 1069;
            constexpr uint32 Keyword_Implements = 1070;
            constexpr uint32 Keyword_Extends = 1071;
            constexpr uint32 Keyword_Escape = 1072;
            constexpr uint32 Keyword_Menubar = 1073;
            constexpr uint32 Keyword_Function = 1074;
            constexpr uint32 Keyword_Double = 1075;
            constexpr uint32 Keyword_Routeevent = 1076;
            constexpr uint32 Keyword_Top = 1077;
            constexpr uint32 Keyword_Valueof = 1078;
            constexpr uint32 Keyword_Class = 1079;
            constexpr uint32 Keyword_Try = 1080;
            constexpr uint32 Keyword_For = 1081;
            constexpr uint32 Keyword_Statusbar = 1082;
            constexpr uint32 Keyword_Continue = 1083;
            constexpr uint32 Keyword_Isnan = 1084;
            constexpr uint32 Keyword_Alert = 1085;
            constexpr uint32 Keyword_Prototype = 1086;
            constexpr uint32 Keyword_Status = 1087;
            constexpr uint32 Keyword_Else = 1088;
            constexpr uint32 Keyword_Find = 1089;
            constexpr uint32 Keyword_Personalbar = 1090;
            constexpr uint32 Keyword_Outerwidth = 1091;
            constexpr uint32 Keyword_Break = 1092;
            constexpr uint32 Keyword_Stop = 1093;
            constexpr uint32 Keyword_Xor = 1094;
            constexpr uint32 Keyword_Public = 1095;
            constexpr uint32 Keyword_Pagexoffset = 1096;
            constexpr uint32 Keyword_Mov = 1097;
            constexpr uint32 Keyword_Static = 1098;
            constexpr uint32 Keyword_Retn = 1099;
            constexpr uint32 Keyword_Home = 1100;
            constexpr uint32 Keyword_Open = 1101;
            constexpr uint32 Keyword_Date = 1102;
            constexpr uint32 Keyword_Netscape = 1103;
            constexpr uint32 Keyword_Pageyoffset = 1104;
            constexpr uint32 Keyword_This = 1105;
            constexpr uint32 Keyword_Innerwidth = 1106;
            constexpr uint32 Keyword_Scroll = 1107;
            constexpr uint32 Keyword_Opener = 1108;
            constexpr uint32 Keyword_Prompt = 1109;
            constexpr uint32 Keyword_Unescape = 1110;
            constexpr uint32 Keyword_Parsefloat = 1111;
            constexpr uint32 Keyword_Unwatch = 1112;
            constexpr uint32 Keyword_Cleartimeout = 1113;
            constexpr uint32 Keyword_Parent = 1114;
            constexpr uint32 Keyword_Closed = 1115;
            constexpr uint32 Keyword_Outerheight = 1116;
            constexpr uint32 Keyword_Math = 1117;
            constexpr uint32 Keyword_Synchronized = 1118;
            constexpr uint32 Keyword_Constructor = 1119;
            constexpr uint32 Keyword_Goto = 1120;
            constexpr uint32 Keyword_Super = 1121;
            constexpr uint32 Keyword_Regexp = 1122;
            constexpr uint32 Keyword_Locationbar = 1123;
            constexpr uint32 Keyword_Export = 1124;
            constexpr uint32 Keyword_Toolbar = 1125;
            constexpr uint32 Keyword_Setinterval = 1126;
        /*  constexpr uint32 Keyword_Clearinterval = 1000;
            constexpr uint32 Keyword_Java          = 1001;
            constexpr uint32 Keyword_Eval          = 1002;
            constexpr uint32 Keyword_Settimeout    = 1003;
            ...
            // To be added in TokenType namespace
            constexpr uint32 Datatype_Dword_ptr = 6000;
            constexpr uint32 Datatype_String = 6001;
            constexpr uint32 Datatype_Number = 6002;
            constexpr uint32 Datatype_Dword = 6003;
     //   constexpr uint32 Datatype_Void = 6004;
     //   constexpr uint32 Datatype_Let = 6005;
